...
public class TestEducationLoan {
	...
	public void setup() {
		...
		EducationLoan e1 = new EducationLoan(16900d, d1, 2, 9000d, 160000d, "BA", "Ajax", 399991310l, user);
		EducationLoan e2 = new EducationLoan(16000d, d2, 2, 9000d, 160000d, "BA", "Ajax", 399991310l, user);
	...
	public void testupdateEducationLoanDetails() {
		...
		Date d1 = new Date(12, 05, 1997);
		EducationLoan e = new EducationLoan(79000d, d1, 2, 9000d, 160000d, "BSC", "Ramesh", 348771310l, user);
